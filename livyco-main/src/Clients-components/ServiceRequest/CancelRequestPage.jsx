...
const CancelRequestPage = () => {
  ...
  const [showSuccess, setShowSuccess] = useState(false);  // ✅ FIXED: Defined state
  ...
  const handleSubmit = () => {
    ...
    // Simulate API call and show success popup
    setShowSuccess(true);

    // Automatically close popup and navigate after 2 seconds
    setTimeout(() => {
